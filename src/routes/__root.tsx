...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Prem Patel — premp.in" },
      { name: "description", content: "Prem Patel — explorer at heart. Android apps for a living; a self-hosted homelab and AI-driven workflows for the joy of it." },
      { name: "author", content: "Prem Patel" },
      { property: "og:title", content: "Prem Patel — premp.in" },
      { property: "og:description", content: "Explorer at heart. Android by day; self-hosted homelab and AI workflows by night." },
